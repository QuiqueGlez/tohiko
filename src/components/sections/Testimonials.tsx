  ...
  return (
    <section className="relative bg-white py-10 lg:py-20 overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        {/* Grid de beneficios */}
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-6 justify-items-center max-w-7xl mx-auto">
            {/* Equipo propio */}
          ...
          <div className="group bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-100 hover:border-blue-100 transition-all duration-300 hover:-translate-y-2 p-8 text-center">
            <div className="bg-gradient-to-br from-blue-600 to-blue-400 w-16 h-16 rounded-2xl flex items-center justify-center mb-6 text-white mx-auto">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-4">Seguro RC y garantía 2 años</h3>
          ...
          <div className="group bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-100 hover:border-blue-100 transition-all duration-300 hover:-translate-y-2 p-8 text-center">
            <div className="bg-gradient-to-br from-blue-600 to-blue-400 w-16 h-16 rounded-2xl flex items-center justify-center mb-6 text-white mx-auto">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-4">Gestión integral de licencias</h3>
        ...
        <div className="mt-10 lg:mt-20 text-center">
          ...
          <p className="mt-4 text-gray-500 text-sm">
            <strong>Reformas Granada</strong> disponible 24h - Presupuestos urgentes - Servicio en toda la provincia
          </p>
        </div>
      </div>
    </section>
