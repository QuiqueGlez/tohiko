...
const MaracenaContent: React.FC = () => {
  return (
    <>
      <Navbar />
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl md:text-6xl font-bold mb-6">
              Reformas en <span className="text-blue-300">Maracena</span>
            </h1>
            <p className="text-xl md:text-2xl mb-8 text-blue-100">
              Especialistas en reformas en Maracena. Experiencia en viviendas residenciales en el área metropolitana oeste
            </p>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-center mb-12 text-gray-900">
              Nuestros servicios en Maracena
            </h2>
              ...
              <div className="group bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-100 hover:border-blue-100 transition-all duration-300 hover:-translate-y-2">
                <div className="relative">
                  <img 
                    ...
                    alt="Reforma integral en Maracena" 
              ...
              <div className="group bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-100 hover:border-blue-100 transition-all duration-300 hover:-translate-y-2">
                <div className="relative">
                  <img 
                    ...
                    alt="Reforma de baño en Maracena" 
                    className="w-full h-48 object-cover"
                  />
                  <div className="absolute bottom-0 left-0 w-full bg-gradient-to-t from-black/60 to-transparent p-4">
              ...
              <div className="group bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-100 hover:border-blue-100 transition-all duration-300 hover:-translate-y-2">
                <div className="relative">
                  <img 
                    ...
                    alt="Reforma de local comercial en Maracena" 
                    className="w-full h-48 object-cover"
                  />
                  <div className="absolute bottom-0 left-0 w-full bg-gradient-to-t from-black/60 to-transparent p-4">
              ...
              <div className="group bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-100 hover:border-blue-100 transition-all duration-300 hover:-translate-y-2">
                <div className="relative">
                  <img 
                    ...
                    alt="Reforma de comunidades de vecinos en Maracena" 
                    className="w-full h-48 object-cover"
                  />
                  <div className="absolute bottom-0 left-0 w-full bg-gradient-to-t from-black/60 to-transparent p-4">
              ...
              <div className="group bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-100 hover:border-blue-100 transition-all duration-300 hover:-translate-y-2">
                <div className="relative">
                  <img 
                    ...
                    alt="Reforma de piscinas en Maracena" 
                    className="w-full h-48 object-cover"
                  />
                  <div className="absolute bottom-0 left-0 w-full bg-gradient-to-t from-black/60 to-transparent p-4">
              ...
              <div className="group bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-100 hover:border-blue-100 transition-all duration-300 hover:-translate-y-2">
                <div className="relative">
                  <img 
                    ...
                    alt="Trabajos complementarios en Maracena" 
                    className="w-full h-48 object-cover"
                  />
                  <div className="absolute bottom-0 left-0 w-full bg-gradient-to-t from-black/60 to-transparent p-4">
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-center mb-12 text-gray-900">
              Trabajamos en todas las zonas de Maracena
            </h2>
            
            <div className="grid md:grid-cols-2 gap-8">
              <div>
                <h3 className="text-xl font-bold mb-4">Maracena Centro</h3>
              ...
              <div>
                <h3 className="text-xl font-bold mb-4">Zona Norte y Expansión</h3>
                <ul className="space-y-2 text-gray-600">
                  <li>• Nuevas urbanizaciones</li>
                  <li>• Zona de desarrollo</li>
                  <li>• Área metropolitana</li>
                  <li>• Acceso a autovía</li>
                </ul>
              </div>
            </div>
          </div>
      ...
      {/* Ventajas de trabajar en Maracena */}
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-center mb-12 text-gray-900">
              ¿Por qué somos especialistas en Maracena?
            </h2>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="text-center">
                ...
                <h3 className="text-xl font-bold mb-4">Zona residencial en auge</h3>
                <p className="text-gray-600">Experiencia en las nuevas viviendas y desarrollos residenciales de Maracena.</p>
              </div>
              ...
              <div className="text-center">
                ...
                <h3 className="text-xl font-bold mb-4">Excelente conectividad</h3>
                <p className="text-gray-600">Ubicación privilegiada con fácil acceso a Granada capital y buenas comunicaciones.</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-3xl md:text-4xl font-bold mb-6">
              ¿Tienes un proyecto en Maracena?
            </h2>
            ...
            <StandardContactForm 
              location="Maracena" 
              placeholder="Describe tu proyecto en Maracena..." 
            />
          </div>
        </div>
      </section>
...
export default MaracenaContent
