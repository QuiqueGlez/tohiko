            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              <div className="bg-white rounded-xl p-6 shadow-lg">
                ...
                <p className="text-gray-600">
                  Renovación completa de viviendas en el área metropolitana oeste de Granada.
                </p>
              </div>
              ...
              <div className="bg-white rounded-xl p-6 shadow-lg">
                ...
                <p className="text-gray-600">
                  Modernización de bloques residenciales y mejoras de eficiencia energética.
                </p>
              </div>
              ...
              <div className="bg-white rounded-xl p-6 shadow-lg">
                ...
                <p className="text-gray-600">
                  Baños, cocinas y salones adaptados al estilo de vida de Maracena.
                </p>
              </div>
            </div>
          </div>
