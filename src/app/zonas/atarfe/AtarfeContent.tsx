          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              <div className="bg-white rounded-xl p-6 shadow-lg">
                ...
                <h3 className="text-xl font-bold mb-4">Reformas Históricas</h3>
                <p className="text-gray-600">Renovación de viviendas históricas respetando la arquitectura tradicional de Atarfe.</p>
              </div>
              <div className="bg-white rounded-xl p-6 shadow-lg">
                <FaBuilding className="text-3xl text-blue-600 mb-4" />
                <h3 className="text-xl font-bold mb-4">Reformas Modernas</h3>
                <p className="text-gray-600">Modernización de viviendas en las nuevas zonas residenciales.</p>
              </div>
              <div className="bg-white rounded-xl p-6 shadow-lg">
                <FaMapMarkerAlt className="text-3xl text-blue-600 mb-4" />
                <h3 className="text-xl font-bold mb-4">Reformas Parciales</h3>
                <p className="text-gray-600">Baños, cocinas y espacios específicos en Atarfe.</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="bg-white rounded-xl p-8 max-w-md mx-auto">
              <form className="space-y-4">
                ...
                <textarea placeholder="Describe tu proyecto en Atarfe..." rows={3} className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 text-gray-900" />
